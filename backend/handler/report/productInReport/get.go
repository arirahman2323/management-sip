...
func GetProductInReport(db *sql.DB) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		var pinItems []report.InventoryReportProductIn
		for rows.Next() {
			var it report.InventoryReportProductIn
			if err := rows.Scan(
				&it.ProductID,
				&it.Quantity,
				&it.CreatedAt,
