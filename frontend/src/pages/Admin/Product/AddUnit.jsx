...
const AddUnit = ({ isOpen, onClose }) => {
  ...
  // Contoh data satuan yang sudah ada
  const existingUnits = ["Pcs", "Bungkus", "Pack", "Kg"];

  return (
    // z-60 agar muncul di atas modal utama (yang z-50)
    <div className="fixed inset-0 bg-transparent bg-opacity-30 flex justify-center items-center z-60">
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
        ...
        {/* Input untuk Menambah Satuan Baru */}
        <div>
          <label
            htmlFor="new-unit"
          ...
          <div className="flex items-center gap-2 mt-1">
            <input
              type="text"
              id="new-unit"
              placeholder="Masukan Nama Satuan Anda"
