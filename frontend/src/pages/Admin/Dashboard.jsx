...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      setIsLoading(true);
      try {
        const res = await axiosInstance.get(API_PATHS.DASHBOARD.GET_DASHBOARD(selectedYear));
    ...
    <DashboardLayout>
      <div className="p-6 min-h-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          />
          <ProductTable title="Produk kadaluarsa" subtitle="15 produk kadaluarsa" products={productHasExpired} icon={<BsRecycle className="h-6 w-6 text-red-500" />} detail="/product-expired" radiusColor={"bg-red-400"} />
