...
// Tambahkan prop 'onConfirm' untuk menangani aksi 'Yes'
const Arrived = ({ isOpen, onClose, onConfirm }) => {
    ...
    <div className="fixed inset-0 bg-transparent bg-opacity-50 backdrop-blur-sm flex justify-center items-center z-50">
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-sm text-center">
        ...
        <h3 className="text-lg font-medium leading-6 text-gray-900 mb-2">
          Apakah Anda yakin barang sudah datang?
        </h3>

        {/* Tombol Aksi */}
        <div className="mt-6 flex justify-center gap-4">
          <button
            onClick={onClose} // Tombol Cancel hanya menutup modal
            type="button"
          ...
          <button
            onClick={onConfirm} // Tombol Yes akan menjalankan konfirmasi
            type="button"
