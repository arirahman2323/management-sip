      ...
      <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
        <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-lg">
          ...
          <div
            ...
            className="text-center p-6 rounded-lg mb-4 bg-gray-100 cursor-pointer transition-all"
          >
            <CameraIcon className="h-12 w-12 mx-auto text-gray-400" />
            <p className="mt-2 text-sm text-gray-600">
              Klik untuk Memindai SKU Produk
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="flex flex-col">
              ...
              <select
                ...
                className="bg-gray-50 rounded-lg p-3 text-sm text-gray-900 focus:outline-gray-500"
                disabled={isLoading}
              >
                <option value="">
                  {isLoading ? "Memuat..." : "Pilih produk atau pindai"}
                </option>
            ...
            <div className="flex flex-col">
              ...
              <textarea
                ...
                onChange={handleInputChange}
                className="bg-gray-50 rounded-lg p-3 text-sm text-gray-900 focus:outline-gray-500"
                placeholder="Contoh: Pengiriman awal bulan"
                rows="3"
              ></textarea>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                onChange={handleInputChange}
                className="bg-gray-50 text-gray-900 text-sm p-3 rounded-lg focus:outline-gray-500"
              />
            </div>
